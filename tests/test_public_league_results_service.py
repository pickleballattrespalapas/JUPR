...
def test_public_league_results_overview_excludes_inactive_leagues() -> None:
    ...
    assert overview["leagues"] == [{"name": "Open", "min_games": 4, "k_factor": 24}]
...
def test_public_league_results_builds_standings_weekly_and_highlights() -> None:
    ...
    assert payload["weeks"] == [{"week_num": 1, "week_label": "Week 1"}, {"week_num": 2, "week_label": "Week 2"}]
    ...
    assert payload["highlights"]["most_active"]
