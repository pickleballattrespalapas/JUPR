...
def test_minimum_games_filters_performance_cards_without_hiding_current_rating_or_rows():
    sb = fixture()
    sb.store["pcs_club_sites"][0]["published"]["leaderboard"]["min_games"] = 3
