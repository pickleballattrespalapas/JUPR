    ...
    {detail && detailIsCurrent ? <>
      <article style={cardStyle}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "0.75rem" }}>
          ...
          <label><input type="checkbox" checked={Boolean(settings.partner_board_enabled)} onChange={(e) => setSettings((s) => ({ ...s, partner_board_enabled: e.target.checked }))} disabled={!detailIsCurrent || busy} /> Players Needing Partners enabled</label>
        </div>
