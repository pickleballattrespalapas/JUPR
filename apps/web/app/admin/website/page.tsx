    ...
    <section>
      ...
      <div className={editor.toolbar}>
        <div>
          ...
          <small>
            ...
            {site.published &&
              ` · ${site.published.visibility === "listed" ? "Listed in directory" : "Accessible by link"}`}
          </small>
        </div>
      ...
      {!site.club_active && (
        <p className={styles.notice}>
          Complete club activation in Club settings before publishing.
        </p>
      )}
      {error && (
        ...
        {tab === "identity" && (
          <div className={`${styles.card} ${styles.form}`}>
            ...
            <label>
              ...
              >
                <option value="listed">
                  Listed — appear in club search and the A–Z directory
                </option>
                <option value="unlisted">
                  Unlisted — accessible by link, hidden from the directory
                </option>
              </select>
            </label>
            <p>
            ...
            <div className={styles.notice}>
              ...
              <p>
                ...
                {doc.visibility === "listed"
                  ? "Publication will list this club in the directory."
