...
export default function InterclubPage() {
 ...
 <div>Divisions {['3.5','4.0','4.5/Open'].map(d=><label key={d} style={{marginLeft:16}}><input type="checkbox" checked={draft.divisions.includes(d)} onChange={()=>edit({divisions:toggle(draft.divisions,d)})}/>{d}</label>)}</div>
