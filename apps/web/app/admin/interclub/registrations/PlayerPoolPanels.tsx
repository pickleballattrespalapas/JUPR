...
function SeasonPoolPanel({ root, accessToken, clubName, season, refreshKey, onLateRequested }: PoolProps) {
  ...
  return <section className={styles.panel} aria-label="Season player pool">
    ...
    {data && <>
      ...
      {requestingLate && canRequestLate && <PoolLateRequest root={root} accessToken={accessToken} members={data.members} disabled={resource.disabled} onClose={() => setRequestingLate(false)} onRequest={requestLate} />}
