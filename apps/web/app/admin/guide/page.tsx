...
const migratedSafetyContracts: MigratedSafetyContract[] = [
  ...
  { area: "Match Canonical Audit", route: "GET options; POST /admin/clubs/{club_id}/match-canonical-audit/run", action: "Review players or compare canonical facts", permission: "view_audit_log", phrase: "None — read-only", stop: "Read scope is wrong or canonical facts cannot be loaded.", fallback: "Streamlit Match Canonical Audit" },
