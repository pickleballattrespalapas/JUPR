...
export default async function AdminLeagueCreatePage() {
  ...
  return (
    <section>
      ...
      <h1 style={{ marginTop: 0 }}>Create league draft</h1>
      <LeagueManagerNav managerOnly />
      <p style={{ color: "#334155", maxWidth: "720px" }}>
        Choose the league structure and create an inactive draft. League mode and match format cannot be casually converted later.
      </p>
