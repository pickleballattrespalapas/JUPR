  ...
  return (
    <section style={{ display: "grid", gap: "1rem" }}>
      <article style={cardStyle}>
        ...
        <p style={{ color: "#475569" }}>League list/detail, schedule preview, roster snapshot, guarded settings edits, and roster membership changes. Score submission and awards still remain on Streamlit until their write contracts are ported.</p>
