...
export default async function AdminToolsPage() {
  ...
  return (
    <section>
      ...
      <p style={{ color: "#334155", maxWidth: "880px" }}>Review admin activity, inspect system health, manage staff role assignments, run guarded badge workers/recompute, and preview missing tournament-match backfill candidates through FastAPI. Tournament backfill apply and remaining maintenance migrations stay on Streamlit fallback.</p>
