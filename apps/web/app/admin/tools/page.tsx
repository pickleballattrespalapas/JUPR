...
export default async function AdminToolsPage() {
  ...
  return (
    <section>
      ...
      <p style={{ color: "#334155", maxWidth: "880px" }}>Review admin activity, inspect system health, manage staff role assignments, run guarded badge workers/recompute, and review/apply selected legacy tournament-match backfills through FastAPI. Remaining one-time maintenance migrations stay on Streamlit fallback.</p>
