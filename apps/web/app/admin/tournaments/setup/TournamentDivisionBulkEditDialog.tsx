...
function changedFields(before: SetupRecord, after: SetupRecord): string[] {
  const fields: Array<[string, unknown, unknown]> = [
    ...
    ["Players Needing Partners", before.partner_board_enabled, after.partner_board_enabled],
