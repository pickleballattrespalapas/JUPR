...
const newSponsor = (): SponsorDraft => ({ id: crypto.randomUUID(), name: "", tier: "supporting", level: "", public_description: "", notes: "", website: "", logo_path: "", logo_url: "", is_visible: true });
