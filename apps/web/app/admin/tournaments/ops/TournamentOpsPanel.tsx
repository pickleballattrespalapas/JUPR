  ...
  return (
    <section style={{ display: "grid", gap: "1rem" }}>
      <article style={cardStyle}>
        ...
        <p style={{ color: "#475569" }}>Operations visibility plus guarded writes for creating draws, maintaining teams, generating/scoring round-robin games, generating/scoring playoff games, generating draw-scoped podiums, and awarding podium trophies.</p>
