...
export default async function AdminTournamentStatusPage() {
  ...
  return (
    <section>
      ...
      <h1 style={{ marginTop: 0 }}>Tournament status actions</h1>
      <p style={{ color: "#334155", maxWidth: "860px" }}>
        Reversible archive/unarchive actions for tournament shells through guarded FastAPI writes. Streamlit remains the fallback for Delete Draft and deeper tournament operations.
      </p>
