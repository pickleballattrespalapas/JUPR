...
export default function NotFound() {
  return (
    <section style={{ maxWidth: "860px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>We could not find that JUPR page.</h1>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem" }}>
        <article style={cardStyle}><strong><Link href="/">Home</Link></strong><p style={{ color: "#475569" }}>Return to the JUPR homepage.</p></article>
