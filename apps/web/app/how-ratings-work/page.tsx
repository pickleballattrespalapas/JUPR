...
export default function HowRatingsWorkPage() {
  return (
    <section style={{ maxWidth: "820px" }}>
      ...
      <h1 style={{ marginTop: 0 }}>How JUPR ratings work</h1>
      <p style={{ color: "#334155" }}>
        JUPR turns club match results into a durable rating and leaderboard experience. The public web app will expose the pieces players care about most: current rating, match history, event results, and movement over time.
      </p>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1rem" }}>
        ...
        <article style={{ border: "1px solid #e2e8f0", borderRadius: "14px", padding: "1rem", background: "white" }}>
          ...
          <p style={{ color: "#475569" }}>Submitted official matches update JUPR and club-specific leaderboards.</p>
        </article>
        <article style={{ border: "1px solid #e2e8f0", borderRadius: "14px", padding: "1rem", background: "white" }}>
          <h2 style={{ marginTop: 0, fontSize: "1.1rem" }}>Players can follow progress</h2>
          <p style={{ color: "#475569" }}>Player profiles will collect current rating, recent matches, movement, and badges.</p>
        </article>
      </div>
