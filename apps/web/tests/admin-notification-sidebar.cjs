...
async function sidebarRendersLinkedAccessibleSummaries() {
  ...
  for (const [href, count, title] of [['/admin/notifications', 3, 'Title pool'], ['/admin/tournaments', 1, 'Title tournament'], ['/admin/play-generators/submissions', 1, 'Title generator']]) {
