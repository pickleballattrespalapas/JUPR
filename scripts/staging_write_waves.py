...
STAGING_WRITE_WAVE_ROUTES: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "public-intake-auth": (
        ...
        ("POST", "/clubs/{club_slug}/tournament-registration/partner-profile-resolution"),
        ("POST", "/clubs/{club_slug}/tournament-registration/pairing-interest"),
        ("POST", "/clubs/{club_slug}/tournament-registration/partner-invitations"),
        ("POST", "/clubs/{club_slug}/tournament-registration/partner-invitations/review"),
        ("POST", "/clubs/{club_slug}/tournament-registration/partner-invitations/respond"),
    ...
    "admin-tools": (
        ...
        ("POST", "/admin/clubs/{club_id}/staff/invitations"),
        ("POST", "/admin/clubs/{club_id}/staff/invitations/{invitation_id}/cancel"),
        ("POST", "/staff-invitations/{invitation_id}/accept"),
        ("POST", "/staff-invitations/{invitation_id}/sign-in"),
        ("PUT", "/admin/clubs/{club_id}/settings"),
        ("POST", "/clubs/create"),
        ...
        ("POST", "/admin/clubs/{club_id}/interclub/competition/{season_id}/meets/{meet_id}/{phase}/generate"),
        ("PUT", "/admin/clubs/{club_id}/interclub/competition/{season_id}/meets/{meet_id}/{phase}"),
        ("POST", "/admin/clubs/{club_id}/interclub/competition/{season_id}/meets/{meet_id}/{phase}/refresh-lineups"),
        ("POST", "/admin/clubs/{club_id}/interclub/competition/{season_id}/meets/{meet_id}/{phase}/submit"),
        ("POST", "/admin/clubs/{club_id}/interclub/competition/{season_id}/meets/{meet_id}/{phase}/approve"),
        ("POST", "/admin/clubs/{club_id}/interclub/competition/{season_id}/meets/{meet_id}/{phase}/retry-ratings"),
        ...
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/pool/late-requests"),
        ...
        ("POST", "/club-invitations/{invitation_id}/accept"),
        ("POST", "/club-invitations/{invitation_id}/sign-in"),
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/open"),
        ("PUT", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/registration-window"),
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/participations/{target_club_id}"),
        ("PUT", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/meets/{meet_id}/deadline"),
        ("PUT", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/meets/{meet_id}/teams/{team_id}"),
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/meets/{meet_id}/teams/{team_id}/withdraw"),
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/meets/{meet_id}/teams/{team_id}/eligibility"),
        ("PUT", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/teams/{team_id}"),
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/teams/{team_id}/withdraw"),
        ("POST", "/admin/clubs/{club_id}/interclub/registrations/{season_id}/teams/{team_id}/eligibility"),
        ("POST", "/admin/platform/clubs"),
        ("PATCH", "/admin/platform/clubs/{club_id}/onboarding"),
        ("PATCH", "/admin/platform/clubs/{club_id}/profile"),
    ...
    "tournament-setup": (
        ...
        ("POST", "/admin/clubs/{club_id}/tournaments/setup/tournaments/{tournament_id}/sponsor-logos"),
