...
| CA-008 | `apps/web/app/admin/league-manager/live/LeagueLiveRoundPanel.tsx` | 11 | Create/pause/resume/finish persisted session; Save session snapshot; Publish reviewed scores; Apply reviewed movement; Retry/reconcile/compensate round; Create guest | Version/recovery/round preview evidence present; score publication and movement application are separate guarded actions. | `CA-L` |
