...
| `admin_login` | `auth` | Password login, session restore/refresh, sign-out, invalid/expired token, wrong-club, and permission denial are E2E tested. | Sign in/out with each staging role and approve operator messaging. |
