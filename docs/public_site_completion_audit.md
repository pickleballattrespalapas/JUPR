...
| Challenge Ladder admin | Guarded staging pilot | Status-eligible creation with copyable notices, clock/acceptance, read-only result preview, reviewed publish, official matches, rank movement, cancellation, forfeits, monthly passes, roster append/reactivation, audited tier moves, stale-safe whole-tier replacement, vacation/reinstate overrides, and computed tier-movement review exist. Centralized activity review is available in Admin Tools. |
