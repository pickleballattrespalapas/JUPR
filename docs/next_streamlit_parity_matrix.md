...
16. Validate badge queue/recompute status and dry-run behavior plus tournament-match backfill preview/apply recovery, then port remaining super-admin migrations only after reviewed dry-run/apply contracts and recovery runbooks are hardened.
