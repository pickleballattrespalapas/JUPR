...
PAGE_DEFINITIONS: tuple[PageDefinition, ...] = (
    ...
    PageDefinition("rating_rules", "Rating Rules", public=True),
    ...
    PageDefinition("privacy_policy", "Privacy Policy", public=True, show_in_nav=False),
    PageDefinition("terms_of_use", "Terms of Use", public=True, show_in_nav=False),
    PageDefinition("contact_support", "Contact Support", public=True, show_in_nav=False),
    PageDefinition("data_corrections", "Data Corrections", public=True, show_in_nav=False),
    PageDefinition("email_preferences", "Email Preferences", public=True, show_in_nav=False),
    PageDefinition("profile_privacy", "Profile Privacy", public=True, show_in_nav=False),
    ...
    PageDefinition("tournament_manager", "🛠️ Tournament Setup", admin_only=True),
    PageDefinition("tournament_ops", "📋 Tournament Operations", admin_only=True),
    PageDefinition("tournament_live", "🔴 Tournament Live", admin_only=True),
    ...
    PageDefinition("tournament_partner_request", "🤝 Request Partner", public=True, show_in_nav=False),
