        ...
        if st.button("Submit Batch", key="mu_submit_batch"):
            ...
            if is_popup:
                try:
                    ...
                    st.warning(f"Event tracking unavailable (events table missing?): {exc}")
                    st.session_state.mu_event_id = None
            valid_batch = []
                    ...
                    valid_batch.append(
                        {
                            ...
                            "week_tag": week_tag,
                            "is_popup": is_popup,
                            "context_type": "event" if is_popup and event_id else None,
                            "context_id": event_id if is_popup and event_id else None,
                        }
                    )
                        ...
                        all_res.append(
                            {
                                ...
                                "context_type": "event"
                                if st.session_state.mu_active_is_popup and st.session_state.get("mu_event_id")
                                else None,
