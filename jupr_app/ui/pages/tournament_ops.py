...
def render(ctx):
    ...
    page_shell(
        ...
        "Build draws, manage teams, generate games, and run tournament operations from confirmed registrations.",
                ...
                if modern_mode and selected_draw_id and st.button("Build draw from confirmed registrations"):
                    ...
                    if not entries:
                        ...
                        if not roster_entries:
                            ...
                            st.caption("Hint: Open Tournament Registration to resolve statuses and partner issues.")
                        else:
