...
def build_tournament_registration_edit_email_html(*, tournament_name: str, registered_email: str, edit_url: str, email_sponsors: list[dict] | None = None) -> str:
...
def build_tournament_registration_edit_email_text(*, tournament_name: str, registered_email: str, edit_url: str, email_sponsors: list[dict] | None = None) -> str:
...
def send_tournament_registration_edit_email(*, tournament_name: str, registered_email: str, edit_url: str, smtp_config: SMTPConfig | None = None, email_sponsors: list[dict] | None = None) -> dict[str, str]:
    ...
    provider_message_id = send_email_with_inline_chart(
        ...
        subject=subject,
        html_body=build_tournament_registration_edit_email_html(tournament_name=tournament_name, registered_email=original_to_email, edit_url=edit_url, email_sponsors=email_sponsors),
        text_body=build_tournament_registration_edit_email_text(tournament_name=tournament_name, registered_email=original_to_email, edit_url=edit_url, email_sponsors=email_sponsors),
