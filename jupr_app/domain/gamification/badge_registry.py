...
def registry() -> dict[str, BadgeSpec]:
    specs = [
        ...
        BadgeSpec("clutch_performer", evaluate_clutch_performer, "overall", False, "match_facts_hybrid", "hybrid_safe"),
        ...
        BadgeSpec("nemesis_found", evaluate_nemesis_found, "overall", False, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("rivalry_win", evaluate_rivalry_win, "opponent", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("rivalry_streak", evaluate_rivalry_streak, "opponent", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("settled_the_score", evaluate_settled_the_score, "opponent", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("steady_hand", evaluate_steady_hand, "season", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("mr_reliable", evaluate_mr_reliable, "season", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("league_champion", evaluate_league_champion, "season", True),
        BadgeSpec("podium", evaluate_podium, "season", True),
        BadgeSpec("good_sport", evaluate_good_sport, "overall", True, "non_match", "non_match"),
        BadgeSpec("community_builder", evaluate_community_builder, "overall", True, "non_match", "non_match"),
        BadgeSpec("mentor", evaluate_mentor, "overall", True, "non_match", "non_match"),
        BadgeSpec("breakthrough", evaluate_breakthrough, "league", True, "league_ratings", "non_match"),
        BadgeSpec("above_expectations", evaluate_above_expectations, "match", True, "match_facts_canonical", "canonical_only"),
        BadgeSpec("dominant_run", evaluate_dominant_run, "overall", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("high_output", evaluate_high_output, "overall", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("battle_tested", evaluate_battle_tested, "season", True, "match_facts_hybrid", "hybrid_safe"),
        BadgeSpec("consistency", evaluate_consistency, "season", True, "match_facts_hybrid", "hybrid_safe"),
