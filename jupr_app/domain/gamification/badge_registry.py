...
def registry() -> dict[str, BadgeSpec]:
    specs = [
        ...
        BadgeSpec("high_roller", evaluate_high_roller, "overall", True),
        ...
        BadgeSpec("draft_master", evaluate_draft_master, "week", True),
        ...
        BadgeSpec("breakthrough", evaluate_breakthrough, "lifetime", False),
        BadgeSpec("above_expectations", evaluate_above_expectations, "match", True),
        BadgeSpec("dominant_run", evaluate_dominant_run, "league", True),
        BadgeSpec("high_output", evaluate_high_output, "week", True),
