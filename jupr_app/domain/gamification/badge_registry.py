...
def registry() -> dict[str, BadgeSpec]:
    specs = [
        BadgeSpec("participant", evaluate_participant, "overall", False, "hybrid_safe"),
        BadgeSpec("dedicated_participant_50", evaluate_dedicated_participant_50, "overall", False, "hybrid_safe"),
        BadgeSpec("lifetime_participant_200", evaluate_lifetime_participant_200, "overall", False, "hybrid_safe"),
        BadgeSpec("first_win", evaluate_first_win, "overall", False, "hybrid_safe"),
        BadgeSpec("weekly_regular", evaluate_weekly_regular, "league", False, "hybrid_safe"),
        BadgeSpec("iron_week", evaluate_iron_week, "week", True, "hybrid_safe"),
        BadgeSpec("marathon_month", evaluate_marathon_month, "month", True, "hybrid_safe"),
        BadgeSpec("level_up", evaluate_level_up, "league", True, "non_match"),
        BadgeSpec("rocket_start", evaluate_rocket_start, "league", False, "hybrid_safe"),
        BadgeSpec("most_improved_monthly", evaluate_most_improved_monthly, "month", True, "canonical_only"),
        BadgeSpec("mountain_climber", evaluate_mountain_climber, "league", True, "non_match"),
        BadgeSpec("hot_streak", evaluate_hot_streak, "league", True, "hybrid_safe"),
        BadgeSpec("bounce_back", evaluate_bounce_back, "match", True, "hybrid_safe"),
        BadgeSpec("clutch_performer", evaluate_clutch_performer, "overall", False),
        BadgeSpec("ice_in_veins", evaluate_ice_in_veins, "overall", False, "canonical_only"),
        BadgeSpec("pickle_perfection", evaluate_pickle_perfection, "match", True, "hybrid_safe"),
        BadgeSpec("blowout_artist", evaluate_blowout_artist, "match", True, "hybrid_safe"),
        BadgeSpec("untouchable", evaluate_untouchable, "overall", True, "hybrid_safe"),
        BadgeSpec("clean_sweep_week", evaluate_clean_sweep_week, "week", True, "hybrid_safe"),
        BadgeSpec("high_roller", evaluate_high_roller, "overall", True, "hybrid_safe"),
        BadgeSpec("social_butterfly", evaluate_social_butterfly, "overall", False, "hybrid_safe"),
        BadgeSpec("network_builder", evaluate_network_builder, "overall", False, "hybrid_safe"),
        BadgeSpec("draft_master", evaluate_draft_master, "week", True, "hybrid_safe"),
        BadgeSpec("swiss_army_knife", evaluate_swiss_army_knife, "season", True, "hybrid_safe"),
        BadgeSpec("giant_slayer", evaluate_giant_slayer, "match", True, "canonical_only"),
        BadgeSpec("david_vs_goliath", evaluate_david_vs_goliath, "match", True, "canonical_only"),
        BadgeSpec("upset_champion", evaluate_upset_champion, "match", True, "canonical_only"),
        BadgeSpec("hall_of_fame_night", evaluate_hall_of_fame_night, "league", True, "canonical_only"),
        BadgeSpec("legendary_upset", evaluate_legendary_upset, "match", True, "canonical_only"),
        ...
        BadgeSpec("steady_hand", evaluate_steady_hand, "season", True, "hybrid_safe"),
        ...
        BadgeSpec("breakthrough", evaluate_breakthrough, "overall", False, "non_match"),
        BadgeSpec("above_expectations", evaluate_above_expectations, "overall", True, "canonical_only"),
        BadgeSpec("dominant_run", evaluate_dominant_run, "league", True, "hybrid_safe"),
        BadgeSpec("high_output", evaluate_high_output, "match", True, "hybrid_safe"),
        BadgeSpec("battle_tested", evaluate_battle_tested, "season", True),
        BadgeSpec("consistency", evaluate_consistency, "season", True),
        BadgeSpec("top_performer_highest_rating", evaluate_top_performer_highest_rating, "league", True, "non_match"),
        BadgeSpec("top_performer_most_improved", evaluate_top_performer_most_improved, "league", True, "non_match"),
        BadgeSpec("top_performer_best_win_pct", evaluate_top_performer_best_win_pct, "league", True, "non_match"),
        BadgeSpec("top_performer_most_wins", evaluate_top_performer_most_wins, "league", True, "non_match"),
        BadgeSpec("tournament_champion", evaluate_tournament_champion, "tournament", False, "non_match"),
        BadgeSpec("tournament_runner_up", evaluate_tournament_runner_up, "tournament", False, "non_match"),
        BadgeSpec("tournament_third_place", evaluate_tournament_third_place, "tournament", False, "non_match"),
    ]
