...
def _round_robin_tiebreak_explanations(
    ...
    """Compatibility wrapper for existing admin callers and tests."""

    return build_round_robin_tiebreak_explanations(
        tiebreaks,
        standings,
        rr_games,
    )
...
def build_admin_tournament_day_live_snapshot(
    ...
    *,
    ...
    if not runtime["writes_enabled"]:
        warnings.append("Tournament day writes are runtime-gated; readiness remains independent of this environment gate.")
