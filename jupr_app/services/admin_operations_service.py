...
WORKFLOWS: tuple[AdminWorkflowDefinition, ...] = (
    ...
    AdminWorkflowDefinition(
        ...
        api_scope="manual_batch_score_entry",
        access="staff",
        risk="high",
        env_flag="JUPR_ENABLE_NEXT_ADMIN_MATCH_UPLOADER",
        status_when_disabled="guarded_off",
        next_action="Pilot manual/batch score entry now; add round-robin scheduling and new-player creation in follow-up slices.",
        safety_notes=(
            "Manual/batch submission requires Supabase JWT auth with enter_scores permission.",
