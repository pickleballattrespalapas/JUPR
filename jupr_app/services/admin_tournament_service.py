...
def get_admin_tournament_detail(supabase: Any, *, club_id: str, tournament_id: str) -> dict[str, Any]:
    ...
    selections = _table_rows_for_tournament(supabase, "tournament_registration_selections", SELECTION_SELECT, tournament_id=clean_id)
    ...
    return {
        ...
        "tournament": _tournament_payload(tournament, registration_count=len(registrations_raw), selection_count=len(selections), settings=settings),
        "settings": settings,
        "days": days,
