...
-- Ensure UUID helper functions are available before any defaults use gen_random_uuid().
...
-- Core defaults/keys/constraints expected by application logic.
...
ALTER TABLE public.tournaments
  ...
  ALTER COLUMN playoff_best_of SET DEFAULT 1;
ALTER TABLE public.tournaments
...
ALTER TABLE public.tournament_games
  ADD CONSTRAINT tournament_games_tournament_id_fkey
  FOREIGN KEY (tournament_id) REFERENCES public.tournaments(id) ON DELETE CASCADE;
ALTER TABLE public.tournament_games
  ADD CONSTRAINT tournament_games_team_a_id_fkey
  FOREIGN KEY (team_a_id) REFERENCES public.tournament_teams(id);
ALTER TABLE public.tournament_games
  ADD CONSTRAINT tournament_games_team_b_id_fkey
  FOREIGN KEY (team_b_id) REFERENCES public.tournament_teams(id);
ALTER TABLE public.tournament_games
  ADD CONSTRAINT tournament_games_winner_team_id_fkey
  FOREIGN KEY (winner_team_id) REFERENCES public.tournament_teams(id);
ALTER TABLE public.tournament_games
  ADD CONSTRAINT tournament_games_loser_team_id_fkey
  FOREIGN KEY (loser_team_id) REFERENCES public.tournament_teams(id);
...
ALTER TABLE public.tournament_podium
  ...
  ALTER COLUMN created_at SET NOT NULL;
ALTER TABLE public.tournament_podium
  ADD CONSTRAINT tournament_podium_pkey PRIMARY KEY (id);
ALTER TABLE public.tournament_podium
  ADD CONSTRAINT tournament_podium_tournament_id_fkey
  FOREIGN KEY (tournament_id) REFERENCES public.tournaments(id) ON DELETE CASCADE;
ALTER TABLE public.tournament_podium
  ADD CONSTRAINT tournament_podium_team_id_fkey
  FOREIGN KEY (team_id) REFERENCES public.tournament_teams(id) ON DELETE RESTRICT;
ALTER TABLE public.tournament_podium
  ADD CONSTRAINT tournament_podium_valid_placement CHECK (placement BETWEEN 1 AND 3);
...
CREATE INDEX IF NOT EXISTS idx_tournament_games_series ON public.tournament_games (tournament_id, playoff_game_code, series_game_number);
CREATE INDEX IF NOT EXISTS idx_tournament_podium_tournament_id ON public.tournament_podium (tournament_id);

ALTER TABLE public.tournament_teams
  ADD CONSTRAINT uq_tournament_team_number UNIQUE (tournament_id, team_number);
ALTER TABLE public.tournament_podium
  ADD CONSTRAINT tournament_podium_unique_placement UNIQUE (tournament_id, placement);
ALTER TABLE public.tournament_podium
  ADD CONSTRAINT tournament_podium_unique_team UNIQUE (tournament_id, team_id);
