-- Repair canonical player projections created before primary registrations
-- received player_id values. Safe sources must belong to the tournament club;
-- finalized relationship reviews and cross-club values are queued for staff.
